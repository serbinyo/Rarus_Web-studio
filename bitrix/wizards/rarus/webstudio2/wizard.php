...
class SiteSettingsStep extends CSiteSettingsWizardStep
{
	function InitStep()
	{
		...
		$siteLogo = $this->GetFileContentImgSrc(WIZARD_SITE_PATH."include/company_name.php", "/bitrix/wizards/rarus/webstudio2/site/templates/corp_services/themes/".$themeID."/lang/".LANGUAGE_ID."/logo.gif");
		if (!file_exists(WIZARD_SITE_PATH."include/logo.gif"))
			$siteLogo = "/bitrix/wizards/rarus/webstudio2/site/templates/corp_services/themes/".$themeID."/lang/".LANGUAGE_ID."/logo.gif";
			
		$siteBanner = $this->GetFileContentImgSrc(WIZARD_SITE_PATH."include/banner.php", "/bitrix/wizards/rarus/webstudio2/site/templates/corp_services/images/banner.png");
...
//		$this->content .= '<img src="/bitrix/wizards/rarus/webstudio2/images/'.LANGUAGE_ID.'/banner_processed.png">'.'</div>';
...
//		$this->content .= $this->ShowInputField("textarea", "siteCopy", Array("id" => "site-copy", "class" => "wizard-field", "rows"=>"3")).'</div>';
	...
	{
		$wizard =& $this->GetWizard();
		$this->SaveFile("siteLogo", Array("extensions" => "gif,jpg,jpeg,png", "max_height" => 70, "max_width" => 190, "make_preview" => "Y"));
		$this->SaveFile("siteBanner", Array("extensions" => "gif,jpg,jpeg,png", "max_height" => 600, "max_width" => 600, "make_preview" => "Y"));
