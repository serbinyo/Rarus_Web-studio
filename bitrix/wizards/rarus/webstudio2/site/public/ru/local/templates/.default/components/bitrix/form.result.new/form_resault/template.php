...
<?php if ($arResult["isFormNote"] !== "Y") : ?>
    ...
    <section class="grid feedback feedback--contacts">
        ...
        <textarea class="feedback__textaria" name="form_textarea_<?=$arResult['arQuestionsId'][0]?>" placeholder="Детали проекта"></textarea>
        <label class="feedback__label" for="1">
            <input class="feedback__input" id="1" type="email" name="form_text_<?=$arResult['arQuestionsId'][1]?>" placeholder="Эл. почта">
        </label>
